...
- [ ] `Settings > API Keys` 에서 **Project URL**과 **Publishable key** 복사
- [ ] `lib/src/config/supabase_config.dart` 의 `url`, `publishableKey` 교체

## 4. 인증 설정

- [ ] (개발 중 편의) `Authentication > Sign In / Providers > Email` 에서 **Confirm email 끄기**
